...
<html lang="en" dir="ltr">
  ...
  <body>
      <nav class="navbar navbar-expand-lg bg-light" id="a">
        <a class="navbar-brand" href=" index.html"><img src="img/Bookbuy.png" alt="BookBuy" width="40" height="32"></a>
            ...
            <div class="product-content">
                ...
                <form class="" action="insertcartdata.php" method="post">
                  <div class="d-grid gap-2">
                    ...
                    <button  class=" btn btn-info" type="submit" name="Add" class="btn btn-info">Add to cart</button>
                  </div>
                </form>
